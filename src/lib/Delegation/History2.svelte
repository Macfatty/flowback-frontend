...
<Loader bind:loading>
	<div class="w-screen bg-[#faf5ff] dark:bg-darkbackground pt-4">
		...
		<Structure Class="w-full flex justify-center max-w-full">
			<div
				slot="left"
				class="p-4 bg-white dark:bg-darkobject rounded shadow flex-grow-0 max-w-[600px]"
			>
				{#if filteredVotingHistory.length > 0}
					<ul class="w-full">
			...
			<div slot="right" class="p-4 flex-grow-1">
				<Comments
